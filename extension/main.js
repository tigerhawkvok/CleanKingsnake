...
function loadJQ(jq_path, i, libs) { //load jQuery if it isn't already
    console.log("Checking JQ load",jq_path);
    ...
    window.onload = function() {
        ...
        if (window.jQuery === undefined) loadNextJQ();
            ...
            console.log("Beginning jquery library load");
            ...
            if (typeof(libs) == "object") {
                ...
                var j = 0;
                console.log("Loading from",jsFileLocation);
                $.each(libs, function() {
                    ...
                    j++;
                    console.log("Attempting to load",filepath,j);
